<script lang="ts">
	...
	const classes = $derived(
		[
			'box',
			padding !== undefined && `box--p-${padding}`,
			paddingX !== undefined && `box--px-${paddingX}`,
			paddingY !== undefined && `box--py-${paddingY}`,
			margin !== undefined && `box--m-${margin}`,
			marginX !== undefined && `box--mx-${marginX}`,
			marginY !== undefined && `box--my-${marginY}`,
			bg && `box--bg-${bg}`,
